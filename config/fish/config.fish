...
alias serve='python2 -m SimpleHTTPServer 4321'
...
set -Ua fish_user_paths ~/.npm-packages/bin
set -Ua fish_user_paths /usr/local/opt/postgresql@11/bin

# set -gx PATH "/home/jfo/.bin" "/var/folders/0m/w5lp5n515nqfkkl53913y6q00000gp/T/fnm_multishells/35925_1617801194335/bin"  $PATH;
